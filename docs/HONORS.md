...
| **Çağlar Özenç** | Türkiye'nin uzun vadeli SQL Server seslerinden — yılların sahasında ürün-versiyon-incident üçgeninden geçmiş, dört motorda (SQL Server, PostgreSQL, MySQL, MongoDB) production-grade danışmanlık veren bir kurt. Microsoft MVP — Data Platform. **DMC Bilgi Teknolojileri** kurucusu, **Sentinel DB 360**'ın lead architect'i, bu toolkit'in maintainer'ı. SQL Ekibi üzerinden Türkçe topluluğa düzenli içerik üretir; konferans sahnesinde ve müşteri sahasında aynı netlikle "geceleyin paged olunca ne yapacağız?" sorusunu cevaplar. Bu repo'nun "AI kokmasın, sahadan konuşsun" disiplini onun çizgisidir. | [caglarozenc.com](https://caglarozenc.com) · [linkedin.com/in/caglarozenc](https://linkedin.com/in/caglarozenc) |
