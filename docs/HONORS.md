...
| **Çağlar Özenç** | Sektöre 2007'de yazılım geliştirici olarak başladı; 2012'den bu yana SQL Server DBA. Erken kariyerinde Pervasive SQL'den SQL Server 2000'e geçiş projelerini yönetti, ardından Türkiye'de pek çok kurumsal veri platformu dönüşümünde rol aldı; bugün dört motoru (SQL Server, PostgreSQL, MySQL, MongoDB) aynı disiplinle yöneten bir danışmanlık pratiği yürütüyor. **5 yıl üst üste Microsoft MVP — Azure SQL & SQL Server.** **DMC Bilgi Teknolojileri**'nin kurucusu ve CTO'su, **Sentinel DB 360**'ın baş mimarı, bu toolkit'in maintainer'ı. Yüzlerce Türkçe teknik makale, kurumsal ve bireysel eğitim, ulusal ve uluslararası konferans sunumu üretti. İstanbul merkezli; sahaya, koda ve topluluğa eşit mesafede çalışır. | [caglarozenc.com](https://caglarozenc.com) · [linkedin.com/in/caglarozenc](https://linkedin.com/in/caglarozenc) |
